 ...
 *
 * This is a high-level method of allowing various model implementations to
 * expose parameters, that can then be mapped as output parameters to various
 * input parameters.
 */
// NOTE: implemented as a resource so that it supports saving/loading parameter
// values.
...
MAKE_TYPED_ARRAY(ModelParameter, Variant::OBJECT)
MAKE_TYPED_ARRAY_INFO(ModelParameter, Variant::OBJECT)
