...
protected:
  ...
  void set_format_type(godot::StringName const &p_format);

public:
  [[nodiscard]] godot::StringName get_format_type() const;

  godot::Error add_directory(
    godot::String const &p_path,
    godot::String const &p_basepath,
    bool                 p_recursive = true
  );
  godot::Error add_file(
    godot::String const &p_path,
    godot::String const &p_basepath
  );

  void create_file(godot::String const &p_path);
  void set_file_data(
    godot::String const          &p_path,
    godot::PackedByteArray const &p_data
  );
  godot::PackedByteArray get_file_data(godot::String const &p_path) const;

  godot::Vector<godot::String> get_file_list() const;

  bool _set(godot::StringName const &p_name, godot::Variant const &p_property);
  bool _get(godot::StringName const &p_name, godot::Variant &r_property) const;
  void _get_property_list(godot::List<godot::PropertyInfo> *p_list) const;

  godot::String compute_hash() const;

  godot::Error unpack_bundle(godot::String const &p_path);
  godot::Error pack_bundle(godot::String const &p_path);
};
