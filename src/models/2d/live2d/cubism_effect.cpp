...
void CubismEffect::_bind_methods() {
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_active", "value"), &CubismEffect::set_active
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_active"), &CubismEffect::get_active
  );
  ADD_PROPERTY(
...
void CubismEffect::_cubism_prologue(
  CubismModelProxy *model,
  float const       delta
) {}

void CubismEffect::_cubism_process(
  CubismModelProxy *model,
  float const       delta
) {}

void CubismEffect::_cubism_epilogue(
  CubismModelProxy *model,
  float const       delta
) {}
...
void CubismEffect::_enter_tree() {
  ...
  if (node != nullptr) { node->_on_append_child_act(this); }
}

void CubismEffect::_exit_tree() {
  auto *node = godot::Object::cast_to<CubismModel>(this->get_parent());
  if (node != nullptr) { node->_on_remove_child_act(this); }
}
