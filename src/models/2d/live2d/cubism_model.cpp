...
void CubismModel::_bind_methods() {
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("csm_get_version"), &CubismModel::csm_get_version
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("csm_get_latest_moc_version"),
    &CubismModel::csm_get_latest_moc_version
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("csm_get_moc_version"), &CubismModel::csm_get_moc_version
  );

  // ModelData
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_assets", "assets"), &CubismModel::set_assets
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_assets"), &CubismModel::get_assets
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_load_expressions", "enable"),
    &CubismModel::set_load_expressions
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_load_expressions"), &CubismModel::get_load_expressions
  );
  ADD_PROPERTY(
    godot::PropertyInfo(godot::Variant::BOOL, "load_expressions"),
    "set_load_expressions",
    "get_load_expressions"
  );

  // Enable Load Motions
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_load_motions", "enable"),
    &CubismModel::set_load_motions
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_load_motions"), &CubismModel::get_load_motions
  );
  ADD_PROPERTY(
    godot::PropertyInfo(godot::Variant::BOOL, "load_motions"),
    "set_load_motions",
    "get_load_motions"
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("get_canvas_info"), &CubismModel::get_canvas_info
  );

  godot::ClassDB::bind_method(godot::D_METHOD("clear"), &CubismModel::clear);

  godot::ClassDB::bind_method(
    godot::D_METHOD("set_parameter_mode", "value"),
    &CubismModel::set_parameter_mode
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameter_mode"), &CubismModel::get_parameter_mode
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::INT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_process_callback", "value"),
    &CubismModel::set_process_callback
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_process_callback"), &CubismModel::get_process_callback
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::INT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_speed_scale", "value"), &CubismModel::set_speed_scale
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_speed_scale"), &CubismModel::get_speed_scale
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_auto_scale", "value"), &CubismModel::set_auto_scale
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_auto_scale"), &CubismModel::get_auto_scale
  );
  ADD_PROPERTY(
    godot::PropertyInfo(godot::Variant::BOOL, "auto_scale"),
    "set_auto_scale",
    "get_auto_scale"
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("set_adjust_scale", "value"),
    &CubismModel::set_adjust_scale
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_adjust_scale"), &CubismModel::get_adjust_scale
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_adjust_position", "value"),
    &CubismModel::set_adjust_position
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_adjust_position"), &CubismModel::get_adjust_position
  );
  ADD_PROPERTY(
    godot::PropertyInfo(godot::Variant::VECTOR2, "adjust_position"),
    "set_adjust_position",
    "get_adjust_position"
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("set_mask_viewport_size", "value"),
    &CubismModel::set_mask_viewport_size
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_mask_viewport_size"),
    &CubismModel::get_mask_viewport_size
  );
  ADD_PROPERTY(
    godot::PropertyInfo(godot::Variant::VECTOR2I, "mask_viewport_size"),
    "set_mask_viewport_size",
    "get_mask_viewport_size"
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_add"), &CubismModel::set_shader_add
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_add"), &CubismModel::get_shader_add
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mix"), &CubismModel::set_shader_mix
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mix"), &CubismModel::get_shader_mix
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mul"), &CubismModel::set_shader_mul
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mul"), &CubismModel::get_shader_mul
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask"), &CubismModel::set_shader_mask
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask"), &CubismModel::get_shader_mask
  );
  // MaskAdd
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask_add"), &CubismModel::set_shader_mask_add
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask_add"), &CubismModel::get_shader_mask_add
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask_add_inv"),
    &CubismModel::set_shader_mask_add_inv
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask_add_inv"),
    &CubismModel::get_shader_mask_add_inv
  );
  // MaskMix
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask_mix"), &CubismModel::set_shader_mask_mix
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask_mix"), &CubismModel::get_shader_mask_mix
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask_mix_inv"),
    &CubismModel::set_shader_mask_mix_inv
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask_mix_inv"),
    &CubismModel::get_shader_mask_mix_inv
  );
  // MaskMul
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask_mul"), &CubismModel::set_shader_mask_mul
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask_mul"), &CubismModel::get_shader_mask_mul
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_shader_mask_mul_inv"),
    &CubismModel::set_shader_mask_mul_inv
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_shader_mask_mul_inv"),
  ...
  ADD_PROPERTY(
    ...
    "set_shader_mask_add_inv",
    "get_shader_mask_add_inv"
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::OBJECT,
  ...
  ADD_PROPERTY(
    ...
    "set_shader_mask_mix_inv",
    "get_shader_mask_mix_inv"
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::OBJECT,
  ...
  ADD_PROPERTY(
    ...
    "set_shader_mask_mul_inv",
    "get_shader_mask_mul_inv"
  );

  // CubismMotion
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_motions"), &CubismModel::get_motions
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("start_motion", "group", "no", "priority"),
    &CubismModel::start_motion
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD(
      "start_motion_loop", "group", "no", "priority", "loop", "loop_fade_in"
    ),
    &CubismModel::start_motion_loop
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_cubism_motion_queue_entries"),
    &CubismModel::get_cubism_motion_queue_entries
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("stop_motion"), &CubismModel::stop_motion
  );

  // CubismExpression
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_expressions"), &CubismModel::get_expressions
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("start_expression", "expression_id"),
    &CubismModel::start_expression
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("stop_expression"), &CubismModel::stop_expression
  );

  // HitArea
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_hit_areas"), &CubismModel::get_hit_areas
  );

  // Parameter
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameters"), &CubismModel::get_parameters
  );

  // PartOpacity
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_part_opacities"), &CubismModel::get_part_opacities
  );

  // Meshs
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_meshes"), &CubismModel::get_meshes
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("advance", "delta"), &CubismModel::advance
  );

  ADD_SIGNAL(
    godot::MethodInfo(
      "motion_event", godot::PropertyInfo(godot::Variant::STRING, "value")
    )
  );
...
godot::Dictionary CubismModel::csm_get_version() {
  ...
  Live2D::Cubism::Core::csmVersion const
    version               = Live2D::Cubism::Core::csmGetVersion();
...
CubismModel::moc3FileFormatVersion CubismModel::csm_get_latest_moc_version() {
  return static_cast<moc3FileFormatVersion>(
...
void CubismModel::set_assets(godot::String const p_assets) {
  this->assets                    = p_assets;

  godot::Ref<godot::FileAccess> f = godot::FileAccess::open(
    p_assets, godot::FileAccess::READ
  );
  if (f.is_null()) {
    this->clear();
    ERR_FAIL_MSG(
      godot::vformat(
        "Failed to open .model3.json file '%s': %s",
        p_assets,
        f->get_open_error()
      )
    );
  ...
  if (!this->proxy_model->model_load(p_assets)) {
    ...
    ERR_FAIL_MSG(
      godot::vformat(
        "Failed to load model from .model3.json file '%s'", p_assets
      )
    );
  }
  if (!this->proxy_model->IsInitialized()) {
    ...
    ERR_FAIL_MSG(
      godot::vformat(
        "Failed to initialize model from .model3.json file '%s'", p_assets
      )
    );
  }

  {
    ...
    for (Csm::csmInt32 index = 0; index < model->GetParameterCount();
         index++) {
    ...
    if (
      strcmp(
        this->proxy_model->_model_setting->GetDisplayInfoFileName(), ""
      ) != 0
    ) {
      godot::String display_info_filename;
      auto          err = display_info_filename.parse_utf8(
        this->proxy_model->_model_setting->GetDisplayInfoFileName()
      );
      ERR_FAIL_COND_MSG(err, "Failed to parse display info file name.");

      auto displayinfo_file = godot::FileAccess::open(
        p_assets.get_base_dir().path_join(display_info_filename),
        godot::FileAccess::ModeFlags::READ
      );
      ERR_FAIL_COND_MSG(
        displayinfo_file->get_open_error(),
        godot::vformat(
          "Failed to open display info file: ",
          p_assets.get_base_dir().path_join(display_info_filename)
        )
      );
    ...
    for (Csm::csmInt32 index = 0; index < model->GetParameterCount();
         index++) {
      auto param_id = godot::String(
        Live2D::Cubism::Core::csmGetParameterIds(csm_model)[index]
      );

      // TODO: do we need to expose Live2D::Cubism::Core::csmGetParameterTypes(
      // csm_model
      // )[index];
      //  somehow? it returns "normal" or "blendshape".

      auto param_type = Live2D::Cubism::Core::csmGetParameterTypes(
        csm_model
      )[index];
      ...
      model_param->parameter_minimum =
        Live2D::Cubism::Core::csmGetParameterMinimumValues(csm_model)[index];
      model_param->parameter_maximum =
        Live2D::Cubism::Core::csmGetParameterMaximumValues(csm_model)[index];
      model_param->parameter_default =
        Live2D::Cubism::Core::csmGetParameterDefaultValues(csm_model)[index];
      model_param
        ->parameter_value = Live2D::Cubism::Core::csmGetParameterValues(
        csm_model
      )[index];
...
godot::String CubismModel::get_assets() const { return this->assets; }

void CubismModel::set_load_expressions(bool const enable) {
...
void CubismModel::set_load_motions(bool const enable) {
...
godot::Dictionary CubismModel::get_canvas_info() const {
  ...
  Live2D::Cubism::Core::csmReadCanvasInfo(
    this->proxy_model->GetModel()->GetModel(),
    &vct_pixel_size,
    &vct_pixel_origin,
    &pixel_per_unit
  );

  result["size_in_pixels"] = godot::Vector2(
    vct_pixel_size.X, vct_pixel_size.Y
  );
  result["origin_in_pixels"] = godot::Vector2(
    vct_pixel_origin.X, vct_pixel_origin.Y
  );
...
bool CubismModel::is_initialized() const {
  if (this->proxy_model == nullptr) { return false; }
...
void CubismModel::set_parameter_mode(ParameterMode const value) {
...
void CubismModel::set_process_callback(MotionProcessCallback const value) {
...
void CubismModel::set_speed_scale(float const speed) {
  this->speed_scale = godot::CLAMP<float, float, float>(speed, 0.0, 256.0);
}

float CubismModel::get_speed_scale() const { return this->speed_scale; }

void CubismModel::set_auto_scale(bool const value) {
  this->auto_scale = value;
}

bool CubismModel::get_auto_scale() const { return this->auto_scale; }

godot::Dictionary CubismModel::get_motions() const {
  ERR_FAIL_COND_V(this->is_initialized() == false, godot::Dictionary());
  if (!this->enable_load_motions) { return {}; }
  ...
  for (Csm::csmInt32 i = 0; i < setting->GetMotionGroupCount(); i++) {
    Csm::csmChar const *group = setting->GetMotionGroupName(i);
...
godot::Ref<CubismMotionQueueEntryHandle> CubismModel::start_motion(
...
godot::Ref<CubismMotionQueueEntryHandle> CubismModel::start_motion_loop(
  ...
  if (!this->is_initialized()) { return queue_handle; }

  queue_handle->_handle = this->proxy_model->motion_start(
    str_group.utf8().ptr(), no, priority, loop, loop_fade_in, this
  );
...
godot::Array CubismModel::get_cubism_motion_queue_entries() const {
  ...
  for (Csm::csmVector<Csm::CubismMotionQueueEntry *>::iterator i =
         entry_vector_ptr->Begin();
       i != entry_vector_ptr->End();
       i++) {
...
godot::Array CubismModel::get_expressions() const {
  ERR_FAIL_COND_V(this->is_initialized() == false, godot::Array());
  if (!this->enable_load_expressions) { return {}; }
  ...
  for (Csm::csmInt32 i = 0; i < setting->GetExpressionCount(); i++) {
    Csm::csmChar const *name = setting->GetExpressionName(i);
...
void CubismModel::start_expression(godot::String const str_expression_id) {
  if (!this->is_initialized()) { return; }
...
#ifdef CUBISM_MOTION_CUSTOMDATA
  CubismModel *m = static_cast<CubismModel *>(
    motion->GetFinishedMotionCustomData()
  );
  if (m != nullptr) { m->emit_signal(SIGNAL_MOTION_FINISHED); }
#endif // CUBISM_MOTION_CUSTOMDATA
}

void CubismModel::_update(float const delta) {
  ...
  for (Csm::csmInt32 index = 0; index < this->ary_part_opacity.size();
       index++) {
...
void CubismModel::advance(float const delta) {
...
void CubismModel::setup_property() {
  ...
  if (this->enable_load_expressions) {
    for (Csm::csmInt32 i = 0; i < setting->GetExpressionCount(); i++) {
      Csm::csmChar const *expression_id = setting->GetExpressionName(i);
...
bool CubismModel::_set(
  godot::StringName const &p_name,
  godot::Variant const    &p_value
) {
  if (Model2D::_set(p_name, p_value)) { return true; }
  ...
  if (p_name == godot::String(PROP_ANIM_EXPRESSION)) {
    ...
    if (this->dict_anim_expression.IsExist(this->curr_anim_expression_key)) {
      anim_expression
        anim_e = this->dict_anim_expression[this->curr_anim_expression_key];
...
bool CubismModel::_get(
  godot::StringName const &p_name,
  godot::Variant          &r_ret
) const {
  if (Model2D::_get(p_name, r_ret)) { return true; }
...
bool CubismModel::_property_can_revert(godot::StringName const &p_name) const {
  if (Model2D::_property_can_revert(p_name)) { return true; }

  if (!this->is_initialized()) { return false; }
  Csm::CubismModel *model = this->proxy_model->GetModel();

  if (p_name == godot::String(PROP_ANIM_LOOP)) { return true; }
  if (p_name == godot::String(PROP_ANIM_LOOP_FADE_IN)) { return true; }
...
bool CubismModel::_property_get_revert(
  godot::StringName const &p_name,
  godot::Variant          &r_property
) const {
  if (Model2D::_property_get_revert(p_name, r_property)) { return true; }
...
void CubismModel::_get_property_list(
  godot::List<godot::PropertyInfo> *p_list
) {
  ...
  p_list->push_back(
    godot::PropertyInfo(godot::Variant::BOOL, PROP_ANIM_LOOP_FADE_IN)
  );
...
void CubismModel::_ready() {
  ...
  // Memory leak when set_transparent_background is true(* every time & window
  // minimize) https://github.com/godotengine/godot/issues/89651
...
void CubismModel::_on_remove_child_act(CubismEffect *node) {
  for (Csm::csmVector<CubismEffect *>::iterator i =
         this->_list_cubism_effect.Begin();
       i != this->_list_cubism_effect.End();
       i++) {
    if (*i == node) {
...
godot::Ref<ModelBundle> CubismModel::pack_bundle() {
  ...
  ERR_FAIL_COND_V_MSG(
    err != godot::OK, nullptr, "Failed to pack .model3.json to bundle."
  );
