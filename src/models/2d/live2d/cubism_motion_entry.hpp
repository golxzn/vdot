...
public:
  enum HandleError { OK = godot::Error::OK, FAILED = godot::Error::FAILED };

protected:
  static void _bind_methods() {
    godot::ClassDB::bind_method(
      godot::D_METHOD("get_error"), &CubismMotionQueueEntryHandle::get_error
    );
    ADD_PROPERTY(
      godot::PropertyInfo(godot::Variant::INT, "error"), "", "get_error"
    );
