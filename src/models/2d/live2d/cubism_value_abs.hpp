...
protected:
  static void _bind_methods() {
    godot::ClassDB::bind_method(
      godot::D_METHOD("get_id"), &CubismValueAbs::get_id
    );
    ADD_PROPERTY(
    ...
    godot::ClassDB::bind_method(
      godot::D_METHOD("set_value"), &CubismValueAbs::set_value
    );
    godot::ClassDB::bind_method(
      godot::D_METHOD("get_value"), &CubismValueAbs::get_value
    );
    ADD_PROPERTY(
...
protected:
  ...
  bool            changed;
  ValueType const _value_type = UNKONWN;
...
public:
  ...
  explicit CubismValueAbs(ValueType const value_type)
    : _value_type(value_type) {}

  [[nodiscard]] godot::String get_id() const { return this->id; }
  ...
  void get_raw_value() { this->_value = *this->raw_value; }
};
