...
#include "avatar_bundle.hpp"
#include "avatar_parameter.hpp"
#include "avatar_parameter_eval.hpp"
...
protected:
  ...
  godot::HashMap<godot::StringName, godot::Ref<AvatarParameterEval>>
    parameter_values;
...
public:
  ...
  void _input(godot::Ref<godot::InputEvent> const &p_event) override;
   ...
   */
  void _apply_parameter(godot::StringName const &p_id, float p_value);
