...
void Parameter::_bind_methods() {
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameter_label"), &Parameter::get_parameter_label
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameter_tags"), &Parameter::get_parameter_tags
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::STRING,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameter_minimum_value"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameter_maximum_value"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_parameter_default_value"),
...
godot::StringName Parameter::get_parameter_id() const { return parameter_id; }
