...
void TrackingInterface::_bind_methods() {
    ...
    BIND_VIRTUAL_METHOD( TrackingInterface, get_name, make_hash( &TrackingInterface::get_name ) );
    ...
    BIND_VIRTUAL_METHOD( TrackingInterface, initialize,
                         make_hash( &TrackingInterface::initialize ) );
    BIND_VIRTUAL_METHOD( TrackingInterface, uninitialize,
                         make_hash( &TrackingInterface::uninitialize ) );

    BIND_VIRTUAL_METHOD( TrackingInterface, process, make_hash( &TrackingInterface::process ) );
}
