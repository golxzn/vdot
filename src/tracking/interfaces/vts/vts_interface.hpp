...
#include "tracking/standards/unified_expressions.hpp"
...
public:
  ...
  [[nodiscard]] godot::StringName get_name() const override { return "VTS"; }
  ...
  /**
   * Called by the game to register a new tracker endpoint with the VTS
   * interface.
   *
   * This will create a new VTS facial tracker for the specified address and
   * port.
   *
   ...
   */
  godot::Ref<VTSFaceTracker> register_tracker(
