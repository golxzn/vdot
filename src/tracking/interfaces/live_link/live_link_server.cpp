...
LiveLinkPacket LiveLinkPacket::from_bytes(
...
void LiveLinkClientData::_bind_methods() {
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_forward"), &LiveLinkClientData::_get_jaw_forward
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_right"), &LiveLinkClientData::_get_jaw_right
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_left"), &LiveLinkClientData::_get_jaw_left
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_open"), &LiveLinkClientData::_get_jaw_open
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_close"), &LiveLinkClientData::_get_mouth_close
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_right"), &LiveLinkClientData::_get_mouth_right
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_left"), &LiveLinkClientData::_get_mouth_left
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_cheek_puff"), &LiveLinkClientData::_get_cheek_puff
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_tongue_out"), &LiveLinkClientData::_get_tongue_out
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_head_yaw"), &LiveLinkClientData::_get_head_yaw
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_head_pitch"), &LiveLinkClientData::_get_head_pitch
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_head_roll"), &LiveLinkClientData::_get_head_roll
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
...
void LiveLinkServer::_bind_methods() {
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_port"), &LiveLinkServer::get_port
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_port", "port"), &LiveLinkServer::set_port
  );
  ADD_PROPERTY(
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("listen"), &LiveLinkServer::listen
  );
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_thread_poll"), &LiveLinkServer::_thread_poll
  );
}
...
godot::Error LiveLinkServer::poll() {
  ...
  for (auto const &item : _clients) {
    ...
    auto packet = LiveLinkPacket::from_bytes(
...
uint16_t LiveLinkServer::get_port() const { return _port; }
