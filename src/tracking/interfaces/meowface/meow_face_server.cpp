...
MeowFacePacket MeowFacePacket::from_bytes(
  godot::PackedByteArray const &bytes
) {
...
void MeowFaceClientData::_bind_methods() {
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_blink_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_down_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_in_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_out_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_up_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_squint_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_wide_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_blink_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_down_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_in_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_out_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_look_up_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_squint_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_eye_wide_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_forward"), &MeowFaceClientData::_get_jaw_forward
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_right"), &MeowFaceClientData::_get_jaw_right
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_left"), &MeowFaceClientData::_get_jaw_left
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_jaw_open"), &MeowFaceClientData::_get_jaw_open
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_close"), &MeowFaceClientData::_get_mouth_close
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_funnel"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_pucker"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_right"), &MeowFaceClientData::_get_mouth_right
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_left"), &MeowFaceClientData::_get_mouth_left
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_smile_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_smile_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_frown_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_frown_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_dimple_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_dimple_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_stretch_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_stretch_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_roll_lower"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_roll_upper"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_shrug_lower"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_shrug_upper"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_press_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_press_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_lower_down_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_lower_down_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_upper_up_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_mouth_upper_up_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_brow_down_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_brow_down_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_brow_inner_up"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_brow_outer_up_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_brow_outer_up_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_cheek_puff"), &MeowFaceClientData::_get_cheek_puff
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_cheek_squint_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_cheek_squint_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_nose_sneer_left"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_nose_sneer_right"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_tongue_out"), &MeowFaceClientData::_get_tongue_out
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_head_yaw"), &MeowFaceClientData::_get_head_yaw
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_head_pitch"), &MeowFaceClientData::_get_head_pitch
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_head_roll"), &MeowFaceClientData::_get_head_roll
  );
  ADD_PROPERTY(
    godot::PropertyInfo(
      godot::Variant::FLOAT,
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_left_eye_yaw"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_left_eye_pitch"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_left_eye_roll"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_right_eye_yaw"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_right_eye_pitch"),
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_get_right_eye_roll"),
...
void MeowFaceServer::_bind_methods() {
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_port"), &MeowFaceServer::get_port
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("set_port", "port"), &MeowFaceServer::set_port
  );
  ADD_PROPERTY(
    godot::PropertyInfo(godot::Variant::INT, "port"), "set_port", "get_port"
  );

  godot::ClassDB::bind_method(
    godot::D_METHOD("listen"), &MeowFaceServer::listen
  );
  ...
  godot::ClassDB::bind_method(
    godot::D_METHOD("_thread_poll"), &MeowFaceServer::_thread_poll
  );
}
...
godot::Error MeowFaceServer::listen() {
  if (auto err = _server->listen(_port); err != godot::OK) { return err; }
...
godot::Error MeowFaceServer::stop() {
  ...
  for (auto const &item : _clients) {
    godot::UtilityFunctions::print(
      "Existing MeowFaceFace peer disconnected for shutdown: %s (%s)",
      item.second->_name,
      item.second->_id
    );
...
godot::Error MeowFaceServer::poll() {
  if (auto err = _server->poll(); err != godot::OK) { return err; }

  if (_server->is_connection_available()) {
    auto peer = _server->take_connection();

    if (peer.is_valid()) { _unidentified_clients.push_back(peer); }
  }
  ...
  for (int peer_idx = 0; peer_idx < _unidentified_clients.size(); peer_idx++) {
    ...
    for (int i = 0; i < packet_count - 1; ++i) { auto p = peer->get_packet(); }
    ...
    if (_clients.count(packet.device_id)) {
      ...
      godot::UtilityFunctions::print(
        "New MeowFaceFace peer connected: %s (%s)", client->_name, client->_id
      );
  ...
  if (_unidentified_clients.size() > 0) {
    ...
    for (int peer_idx = 0; peer_idx < _unidentified_clients.size();
         peer_idx++) {
  ...
  for (auto const &item : _clients) {
    ...
    auto packet = MeowFacePacket::from_bytes(
...
uint16_t MeowFaceServer::get_port() const { return _port; }
