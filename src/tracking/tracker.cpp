...
void Tracker::_bind_methods() {
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_tracker_name"), &Tracker::get_tracker_name
  );
  godot::ClassDB::bind_method(
    godot::D_METHOD("get_tracker_description"),
...
godot::StringName Tracker::get_tracker_name() const { return tracker_name; }
