...
void TrackingManagerNode::_enter_tree() {
  godot::UtilityFunctions::push_warning(
    "The TrackingManagerNode is a temporary solutions while we're exploring "
    "better options for "
...
godot::PackedStringArray TrackingManagerNode::
  _get_configuration_warnings() const {
  godot::PackedStringArray ary;

  ary.push_back(
    "This is a temporary solutions while we figure out a better method for "
    "hooking "
