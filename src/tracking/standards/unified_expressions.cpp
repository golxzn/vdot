...
void _init_blend_shape_names() {
  ...
  blend_shape_names[FT_EYE_SQUINT_RIGHT] =
    "Squeezes the right eye socket muscles";
  blend_shape_names[FT_EYE_SQUINT_LEFT] =
  ...
  blend_shape_names[FT_NASAL_CONSTRICT_RIGHT] =
    "Right side nose canal constricts";
  blend_shape_names[FT_NASAL_CONSTRICT_LEFT] =
  ...
  blend_shape_names[FT_LIP_SUCK_UPPER_RIGHT] =
    "Upper right lip part tucks in the mouth";
  blend_shape_names[FT_LIP_SUCK_UPPER_LEFT] =
    "Upper left lip part tucks in the mouth";
  blend_shape_names[FT_LIP_SUCK_LOWER_RIGHT] =
    "Lower right lip part tucks in the mouth";
  blend_shape_names[FT_LIP_SUCK_LOWER_LEFT] =
    "Lower left lip part tucks in the mouth";
  blend_shape_names[FT_LIP_SUCK_CORNER_RIGHT] =
    "Right lip corner folds into the mouth";
  blend_shape_names[FT_LIP_SUCK_CORNER_LEFT] =
    "Left lip corner folds into the mouth";
  blend_shape_names[FT_LIP_FUNNEL_UPPER_RIGHT] =
    "Upper right lip part pushes into a funnel";
  blend_shape_names[FT_LIP_FUNNEL_UPPER_LEFT] =
    "Upper left lip part pushes into a funnel";
  blend_shape_names[FT_LIP_FUNNEL_LOWER_RIGHT] =
    "Lower right lip part pushes into a funnel";
  blend_shape_names[FT_LIP_FUNNEL_LOWER_LEFT] =
    "Lower left lip part pushes into a funnel";
  blend_shape_names[FT_LIP_PUCKER_UPPER_RIGHT] =
    "Upper right lip part pushes outwards";
  blend_shape_names[FT_LIP_PUCKER_UPPER_LEFT] =
    "Upper left lip part pushes outwards";
  blend_shape_names[FT_LIP_PUCKER_LOWER_RIGHT] =
    "Lower right lip part pushes outwards";
  blend_shape_names[FT_LIP_PUCKER_LOWER_LEFT] =
    "Lower left lip part pushes outwards";
  blend_shape_names[FT_MOUTH_UPPER_UP_RIGHT] =
    "Upper right part of the lip pulls up";
  blend_shape_names[FT_MOUTH_UPPER_UP_LEFT] =
    "Upper left part of the lip pulls up";
  blend_shape_names[FT_MOUTH_LOWER_DOWN_RIGHT] =
    "Lower right part of the lip pulls up";
  blend_shape_names[FT_MOUTH_LOWER_DOWN_LEFT] =
    "Lower left part of the lip pulls up";
  blend_shape_names[FT_MOUTH_UPPER_DEEPEN_RIGHT] =
    "Upper right lip part pushes in the cheek";
  blend_shape_names[FT_MOUTH_UPPER_DEEPEN_LEFT] =
  ...
  blend_shape_names[FT_MOUTH_CORNER_SLANT_RIGHT] =
  ...
  blend_shape_names[FT_MOUTH_STRETCH_RIGHT] =
    "Mouth corner lip pulls out and down";
  blend_shape_names[FT_MOUTH_STRETCH_LEFT] =
    "Mouth corner lip pulls out and down";
  blend_shape_names[FT_MOUTH_DIMPLE_RIGHT] =
    "Right lip corner is pushed backwards";
  blend_shape_names[FT_MOUTH_DIMPLE_LEFT] =
    "Left lip corner is pushed backwards";
  blend_shape_names[FT_MOUTH_RAISER_UPPER] =
    "Raises and slightly pushes out the upper mouth";
  blend_shape_names[FT_MOUTH_RAISER_LOWER] =
  ...
  blend_shape_names[FT_MOUTH_TIGHTENER_LEFT] =
  ...
  blend_shape_names[FT_TONGUE_ROLL] =
    "Sides of the tongue funnel, creating a roll";
  blend_shape_names[FT_TONGUE_BLEND_DOWN] =
    "Tongue arches up then down inside the mouth";
  blend_shape_names[FT_TONGUE_CURL_UP] =
    "Tongue arches down then up inside the mouth";
  blend_shape_names[FT_TONGUE_SQUISH] =
  ...
  blend_shape_names[FT_BROW_DOWN_RIGHT] =
  ...
  blend_shape_names[FT_MOUTH_SAD_RIGHT] =
    "Right side of the mouth expresses sadness";
  blend_shape_names[FT_MOUTH_SAD_LEFT] =
...
void _init_arkit_unified_mappings() {
  ...
  unified_to_arkit[FT_EYE_LOOK_DOWN_RIGHT] =
  ...
  unified_to_arkit[FT_BROW_OUTER_UP_RIGHT] =
  ...
  unified_to_arkit[FT_CHEEK_SQUINT_RIGHT] =
  ...
  unified_to_arkit[FT_LIP_SUCK_UPPER_RIGHT] =
    ARKit::BlendShape::MouthRollUpper;
  unified_to_arkit[FT_LIP_SUCK_LOWER_RIGHT] =
  ...
  unified_to_arkit[FT_MOUTH_LOWER_DOWN_RIGHT] =
    ARKit::BlendShape::MouthLowerDownRight;
  unified_to_arkit[FT_MOUTH_LOWER_DOWN_LEFT] =
  ...
  unified_to_arkit[FT_MOUTH_STRETCH_RIGHT] =
    ARKit::BlendShape::MouthStretchRight;
  unified_to_arkit[FT_MOUTH_STRETCH_LEFT] =
    ARKit::BlendShape::MouthStretchLeft;
  unified_to_arkit[FT_MOUTH_DIMPLE_RIGHT] =
  ...
  arkit_to_unified[ARKit::BlendShape::EyeLookDownRight] =
  ...
  arkit_to_unified[ARKit::BlendShape::BrowOuterUpRight] =
  ...
  arkit_to_unified[ARKit::BlendShape::CheekSquintRight] =
  ...
  arkit_to_unified[ARKit::BlendShape::MouthRollUpper] =
    FT_LIP_SUCK_UPPER_RIGHT;
  arkit_to_unified[ARKit::BlendShape::MouthRollLower] =
  ...
  arkit_to_unified[ARKit::BlendShape::MouthLowerDownRight] =
    FT_MOUTH_LOWER_DOWN_RIGHT;
  arkit_to_unified[ARKit::BlendShape::MouthLowerDownLeft] =
  ...
  arkit_to_unified[ARKit::BlendShape::MouthStretchRight] =
    FT_MOUTH_STRETCH_RIGHT;
  arkit_to_unified[ARKit::BlendShape::MouthStretchLeft] =
    FT_MOUTH_STRETCH_LEFT;
  arkit_to_unified[ARKit::BlendShape::MouthDimpleRight] =
